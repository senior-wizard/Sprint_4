...
public class CreateOrderFirefox {
    ...
    public CreateOrderFirefox(String name, String surname, String address, String phoneNumber, String metroStationLocator, String date, String rentalPeriodLocator) {
        this.name = name;
